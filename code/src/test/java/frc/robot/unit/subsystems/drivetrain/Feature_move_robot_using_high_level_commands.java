...
// { 90, new Position(2, 1), 2, new Position(4, 1) }, { 180, new Position(2, 2),
// 2, new Position(2, 0) },
...
// public void Scenario_move_forward(final double heading, final Position
// initialPosition, final double distance,
...
// { 90, new Position(2, 1), 2, new Position(0, 1) }, { 180, new Position(2, 2),
// 2, new Position(2, 4) },
...
// public void Scenario_move_backward(final double heading, final Position
// initialPosition, final double distance,
// final Position finalPosition) {
...
// { 180, new Position(2, 1), 2, new Position(4, 1) }, { 270, new Position(2,
...
// public void Scenario_move_Left(final double heading, final Position
// initialPosition, final double distance,
// final Position finalPosition) {
...
// { 180, new Position(2, 2), 2, new Position(0, 2) }, { 270, new Position(2,
// 2), 2, new Position(2, 4) },
...
// public void Scenario_move_Right(final double heading, final Position
// initialPosition, final double distance,
// final Position finalPosition) {
...
// { 180, new Position(7, 1), 2, new Position(7, 3) }, { 270, new Position(0,
// 3), 2, new Position(0, 5) },
...
// public void Scenario_move_North(final double heading, final Position
// initialPosition, final double distance,
// final Position finalPosition) {
...
// public void Scenario_move_East(final double heading, final Position
// initialPosition, final double distance,
// final Position finalPosition) {
...
// { 180, new Position(2, 2), 1, new Position(1, 2) }, { 270, new Position(7,
// 2), 2, new Position(5, 2) },
...
// public void Scenario_move_West(final double heading, final Position
// initialPosition, final double distance,
// final Position finalPosition) {
...
// public void Scenario_move_South(final double heading, final Position
// initialPosition, final double distance,
// final Position finalPosition) {
