 ...
 * Add your docs here.
 */
public class MoveHalfMeter extends TraceableCommand {
    ...
    @Inject
    public MoveHalfMeter(final ILogger logger, RobotConfig config, IDrivetrainSubsystem drivetrain) {
        super(logger);
    ...
    public MoveHalfMeter withHeading(double heading) {
        _heading = heading;
        return this;
    }
    ...
    public void initialize() {
        ...
        new SequentialCommandGroup(
                new TimedMoveHeading(_logger, _config, _drivetrain).withHeading(_heading).withTime(.4).withVelocity(1),
