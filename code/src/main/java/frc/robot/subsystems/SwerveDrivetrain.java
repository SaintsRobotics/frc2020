...
public class SwerveDrivetrain extends TraceableSubsystem implements IDrivetrainSubsystem {
    ...
    public SwerveDrivetrain(final ILogger logger, final RobotConfig config) {
        ...
        ((CANSparkMax) m_frontLeftTurn).setSmartCurrentLimit(35, 60, 150);
        ...
        ((CANSparkMax) m_frontRightTurn).setSmartCurrentLimit(35, 60, 150);
        ...
        ((CANSparkMax) m_backLeftTurn).setSmartCurrentLimit(35, 60, 150);
        ...
        ((CANSparkMax) m_backRightDrive).setSmartCurrentLimit(35, 60, 150);
    ...
    @Override
    public void move(final double x, final double y, final double theta, final boolean fieldRelative) {
        // TODO Auto-generated method stub
